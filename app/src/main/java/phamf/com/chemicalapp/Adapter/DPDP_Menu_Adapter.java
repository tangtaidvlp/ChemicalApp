...
public class DPDP_Menu_Adapter extends RCV_Menu_Adapter<RO_DPDP> {

    public DPDP_Menu_Adapter(Context context) {
        super(context);
    }
    ...
    @Override
    public void bind_ViewHolder(@NonNull View itemView, RO_DPDP item) {
